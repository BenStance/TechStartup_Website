...
export default function CreateProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const createdProduct = await ShopApi.createProduct(productData);
      
      // If there's an image file to upload, upload it
      if (imageFile) {
        await ShopApi.uploadProductImage(createdProduct.id, imageFile);
      }
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold mt-2">Add New Product</h1>
      </div>
